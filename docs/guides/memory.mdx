...
Generated during weekly consolidation by clustering facts across domains. Dreams are disabled by default — enable them in **Settings > Connections > Memory**.
...
A background loop runs every 30 minutes (configurable in **Settings > Limits**):
